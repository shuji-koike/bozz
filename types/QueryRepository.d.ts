...
export interface QueryRepository_repository_refs_nodes_associatedPullRequests_nodes_baseRef_target {
  readonly __typename: "Blob" | "Commit" | "Tag" | "Tree";
  /**
   * The Git object ID
   */
...
export interface QueryRepository_repository_refs_nodes_associatedPullRequests_nodes_baseRef {
   ...
   */
  readonly target: QueryRepository_repository_refs_nodes_associatedPullRequests_nodes_baseRef_target | null;
}
